...
local BinaryMaxHeapMt

local BinaryMaxHeap = {}

function BinaryMaxHeap.new( iparray_ )
...
function BinaryMaxHeap:enqueue( item, priority )
...
function BinaryMaxHeap:dequeue()
...
function BinaryMaxHeap:empty()
	return self._size <= 0
end

function BinaryMaxHeap:batchenq( iparray )
	local items, priorities = self._items, self._priorities
	local size = self._size
...
BinaryMaxHeapMt = {
	__index = BinaryMaxHeap,
	__len = BinaryMaxHeap.len,
}
      
return setmetatable( BinaryMaxHeap, {
	__call = function( _, ... )
		return BinaryMaxHeap.new( ... )
	end
} )
